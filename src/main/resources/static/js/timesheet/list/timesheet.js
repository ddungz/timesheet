...
//                    [3, 'asc']
    ...
    _getSessionInfo(event) {
        ...
        const month = storage.getItem('timesheetList.month');
        const departmentCode = storage.getItem('timesheetList.departmentCode');
        const groupCode = storage.getItem('timesheetList.groupCode');
    ...
    _goToTimesheetSingle(event) {
        ...
        storage.setItem('timesheetSingle.month', instance.data.month);
        storage.setItem('timesheetSingle.departmentCode', instance.data.departmentCode);
        storage.setItem('timesheetSingle.groupCode', instance.data.groupCode);
        // storage.setItem('timesheetSingle.filtering', table.columns().search());
